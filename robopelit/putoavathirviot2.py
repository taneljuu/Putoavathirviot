...
class Peli:
    ...
    def aloita(self):
        ...
        if os.path.exists("ennatys2.txt"):
            with open("ennatys2.txt") as tiedosto:
        ...
        for sanakirja in self.hirviot:
            if sanakirja["y"]-2*self.hirvio.get_height()-5 <= self.robo_y-self.robo.get_height()+20 < sanakirja["y"] and sanakirja["x"]+self.hirvio.get_width()-15 >= self.robo_x >= sanakirja["x"]-self.hirvio.get_width()+20:
                ...
                if self.pisteet > self.ennatys:
                    ...
                    with open("ennatys2.txt", "w") as tiedosto:
    ...
    def lopetusvalikko(self):
        while True:
            ...
            teksti2 = fontti.render("Aloita uusi peli painamalla ENTER,", True, (255, 255, 255))
            teksti3 = fontti.render("Lopeta ohjelma painamalla Esc.", True, (255, 255, 255))

            #self.naytto.fill((0, 0, 0))  # Tyhjennetään näyttö joka kierroksella
